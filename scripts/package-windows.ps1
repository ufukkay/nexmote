...
param(
    ...
    [string]$AgentReleaseNotes = "NexMote Agent v0.8.3: Kilit ekrani (Winlogon) fare ve klavye etkilesimi, UAC ve oturum girdi restorasyonu.",
    [string]$TechnicianReleaseNotes = "NexMote Teknisyen Konsolu v0.8.3: Kilit ekrani ve UAC girdi iletim optimizasyonu.",
